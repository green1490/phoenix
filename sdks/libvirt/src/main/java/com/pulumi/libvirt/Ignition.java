...
public class Ignition extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="ignitionId", refs={String.class}, tree="[0]")
    private Output<String> ignitionId;

    public Output<String> ignitionId() {
    ...
    public Ignition(java.lang.String name, IgnitionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("libvirt:index/ignition:Ignition", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false, Utilities.getPackageRef());
    }
    ...
    private Ignition(java.lang.String name, Output<java.lang.String> id, @Nullable IgnitionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("libvirt:index/ignition:Ignition", name, state, makeResourceOptions(options, id), false, Utilities.getPackageRef());
    }
