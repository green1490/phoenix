...
public class Volume extends com.pulumi.resources.CustomResource {
    ...
    public Volume(java.lang.String name, @Nullable VolumeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("libvirt:index/volume:Volume", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false, Utilities.getPackageRef());
    }
    ...
    private Volume(java.lang.String name, Output<java.lang.String> id, @Nullable VolumeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("libvirt:index/volume:Volume", name, state, makeResourceOptions(options, id), false, Utilities.getPackageRef());
    }
